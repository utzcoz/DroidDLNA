...
public class GenerateXml {
    ...
    private String documentToString(Document document, boolean omitProlog)
            throws Exception {
    ...
    private Document buildDOM(ContentItem content, boolean nestedItems)
            throws Exception {
    ...
    private void generateRoot(ContentItem content, Document descriptor,
                              boolean nestedItems) {
    ...
    private void populateDescMetadata(Element descElement, DescMeta descMeta) {
    ...
    private String booleanToInt(boolean b) {
        return b ? "1" : "0";
    }
